...
import { parseJobDescription, formatSalaryWithCurrency } from '../utils/parser';
      ...
      <div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 border-t border-b border-slate-100 py-3 text-xs text-slate-600">
          ...
          <div className="flex items-center space-x-1.5">
            ...
            <span className="truncate font-mono" title={formatSalaryWithCurrency(application.salary_range)}>
              {formatSalaryWithCurrency(application.salary_range)}
            </span>
          </div>
